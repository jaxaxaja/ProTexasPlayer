...
{
public:
    BuRangeBuilder() : RangeBuilder(2.0f, 3.1f, 2.3f) {}
    Range buildRfiRange() override { return rangeCreator_.createRange("A2+,K8+,K7s,K6s,Q9+,Q8s,Q7s,22+,JTs,J9s,J8s,J7s,T9s,"
    ...
    ~BuRangeBuilder() override= default;
};
