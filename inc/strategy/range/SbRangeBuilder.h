...
{
public:
    SbRangeBuilder() : RangeBuilder(2.2f, 3.1f, 2.4f) {}
    Range buildRfiRange() override { return rangeCreator_.createRange("A2+,K8+,K7s,K6s,Q9+,Q8s,Q7s,22+,JTs,J9s,J8s,J7s,T9s,T"
    ...
    ~SbRangeBuilder() override = default;
};
